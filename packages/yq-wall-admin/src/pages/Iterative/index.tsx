...
const Home = () => {
    ...
    useEffect(() => {
        ...
        blog_project_iterative.length ? setBlog_IterativeRecording(blog_project_iterative) : getCommitData("letter")
    }, [])
                ...
                <div className='overflow-auto w-full'>
                    <div className='flex justify-center'>
                        <div className='w-[400px]'>
                            <h3 className='text-xl text-center pb-6 font-bold text-gradient block'>letter</h3>
