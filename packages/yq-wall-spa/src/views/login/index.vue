<template>
    <div class="yq-login w-screen h-screen flex justify-center items-center">
        <div class="login-panel flex flex-col justify-center items-center gap-3">
            ...
            <input v-model="username" class="outline-none border-black-300 border-2 rounded-md w-96 p-2" />
            <input v-model="password" class="outline-none border-black-300 border-2 rounded-md w-96 p-2" type="password" />
